...
[![Live Demo](https://img.shields.io/badge/demo-live-brightgreen)](https://birdspotting-4e0da.web.app)
...
```bash
git clone https://github.com/enanale/birdspotting_2025.git
...
```bash
# Create app/.env with Firebase config
...
- Personal sighting log (add sightings from Discovery)
- My Sightings history view
